...
//            RunCommandStdout($"{environmentExecutable} -m pip install {findLinks} {forceInstall} {verboseFlag} --no-warn-script-location {String.Join(" ", packages)}", hideWindows: true);
//        }
...
//            RunCommandStdout($"{pipPath} install {module_name}{version} {findLinks} {forceInstall} {verboseFlag}");
//        }
