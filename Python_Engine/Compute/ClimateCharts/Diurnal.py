...
def diurnal(annual_values: np.ndarray, save_path: str, grouping: str="Daily", months: np.ndarray=np.arange(1, 13, 1), title: str=None, unit: str=None, color: str="black", tone_color: str="black", transparency=False):
