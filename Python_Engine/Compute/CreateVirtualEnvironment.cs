...
//                RunCommandStdout(command: $"{Query.EmbeddedPythonExecutable()} -m virtualenv \"{venvPath}\"", hideWindows: true);
...
//                RunCommandStdout($"{venvExecutable} -m pip freeze > {requirements}", hideWindows: true);
